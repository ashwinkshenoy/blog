<template>
  <div>
    ...
    <!-- Main Post Content -->
    <div class="true-post-content" v-for="(post, index) in post" :key="`post-content-${index}`">
      <img v-lazy="post.jetpack_featured_media_url" :alt="post.slug" class="true-post-content__img" />
      <h1 v-html="getPostTitle(post.title.rendered)" class="true-post-content__title"></h1>
